...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const sessionQuery = useAuthSession({
    query: { queryKey: getAuthSessionQueryKey(), retry: false },
  });
  ...
  useEffect(() => {
    if (sessionQuery.isFetched) setBootstrapped(true);
  ...
  const value = useMemo(
    ...
    [bootstrapped, login, logout, sessionQuery.data, sessionQuery.isLoading, sessionQuery.isSuccess],
  );
