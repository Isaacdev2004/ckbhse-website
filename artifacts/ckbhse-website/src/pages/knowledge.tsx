...
const articles = [
  {
    ...
    excerpt: 'The Construction (Design and Management) Regulations 2015 place critical duties on clients, designers, and contractors. Learn what compliance really means.',
  ...
  },
  {
    ...
    excerpt: 'Practical guidance on transitioning to or implementing ISO 45001, the international standard for occupational health and safety management systems.',
  ...
  },
  {
    ...
    category: 'Wellbeing',
    excerpt: 'Mental health is a critical component of workplace safety. Explore employer obligations under HSE guidance and practical support strategies.',
  ...
  },
  {
    ...
    excerpt: 'A comprehensive guide to conducting fire risk assessments under the Regulatory Reform (Fire Safety) Order 2005.',
    author: 'Michael Chen',
    readTime: '7 min read',
  ...
  },
  {
    ...
    title: 'COSHH Assessments Explained: Protecting Workers from Chemical Hazards',
    category: 'Chemical Safety',
    excerpt: 'Step-by-step guidance on conducting Control of Substances Hazardous to Health assessments and implementing effective control measures.',
    author: 'Sarah Mitchell',
    readTime: '9 min read',
  ...
  },
  {
    ...
    excerpt: 'Learn proven investigation methodologies to identify underlying causes and prevent future workplace incidents.',
    author: 'Dr. James Parker',
  ...
  },
  {
    ...
    excerpt: 'Navigate the complex landscape of environmental regulations affecting UK manufacturing operations, from emissions to waste management.',
    author: 'Emma Richardson',
    readTime: '8 min read',
  ...
  },
  {
    ...
    excerpt: 'Understanding legal requirements and best practices for implementing health surveillance programs in high-risk industries.',
    author: 'Michael Chen',
    readTime: '7 min read',
...
const categories = ['All', 'Construction', 'ISO Compliance', 'Fire Safety', 'Chemical Safety', 'Safety Management', 'Environmental', 'Wellbeing', 'Occupational Health'];
  ...
  return (
    <div className="min-h-screen pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl opacity-90 leading-relaxed mb-8">
              Expert insights, regulatory updates, and practical guidance on health, safety, environment, and quality management.
            </p>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display font-bold text-3xl text-foreground mb-8">Featured Articles</h2>
            ...
            {articles.filter(a => a.featured).map((article, index) => (
              ...
              >
                ...
                <div className="px-8 pb-8">
                  <Button variant="outline" className="w-full group" data-testid={`button-read-${article.id}`}>
                    Read Article
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display font-bold text-3xl text-foreground mb-8">Latest Articles</h2>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.filter(a => !a.featured).map((article) => (
              ...
              >
                ...
                <Button variant="ghost" size="sm" className="w-full group" data-testid={`button-read-${article.id}`}>
                  Read More
                  <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </Button>
              </motion.article>
